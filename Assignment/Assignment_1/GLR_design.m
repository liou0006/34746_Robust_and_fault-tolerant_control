function GLR_design(M,h,mu_1,mu_0,sigma)
...
xlabel('amplitude of $2g$')
title(['cdf under H0 and H1 for GLR test, window M =',num2str(M)]);
legend({'$\mathcal{H}_0$';'$\mathcal{H}_1$';'$P_F$';'$P_D$';'$2h$'},'interpreter','latex')
grid
...
legend({'$\mathcal{H}_0$';'$\mathcal{H}_1$';'$2h$'},'interpreter','latex')
grid
mytext = ['$\mu_1 = ',num2str(mu_1,2),'$, $\mu_0 = 0$',', $\sigma = ',num2str(sigma,2),'$'];
text(10,0.2,mytext)
end
